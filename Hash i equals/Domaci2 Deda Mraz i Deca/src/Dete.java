...
public class Dete extends InfoTip {
	...
	public boolean equals(Object o) {
		if (this == o)
			...
			Dete dr = (Dete) o;
			if (Objects.equals(ime, dr.ime) && Objects.equals(prezime, dr.prezime) && 
				this.god == dr.god && this.dl == dr.dl && Objects.equals(g, dr.g) && Objects.equals(k, dr.k) && Objects.equals(dr, dr.d))
				return true;
		}
		return false;
